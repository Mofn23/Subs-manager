...
export function Navbar({ notifications = [] }: { notifications?: NotificationItem[] }) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-apple-bg/80 dark:bg-[#0C0C0E]/80 backdrop-blur-xl border-b border-apple-border dark:border-white/10 transition-all pt-[env(safe-area-inset-top)]">
